...
Once the `conda-forge` channel has been enabled, `json-merge-patch` can be installed with:

```
conda install json-merge-patch
```

It is possible to list all of the versions of `json-merge-patch` available on your platform with:
